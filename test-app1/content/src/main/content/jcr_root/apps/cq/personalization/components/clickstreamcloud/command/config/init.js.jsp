...
%><%@include file="/libs/foundation/global.jsp"%><%
    ...
    Resource contextStoresResource = resourceResolver.getResource("/etc/clientcontext/default/content/jcr:content/stores");
    if( contextStoresResource != null) {
        ...
        Iterator<Resource> it = resourceResolver.listChildren(contextStoresResource);
        while (it.hasNext()) {
