...
%><div class="segmenteditor-and">
    <div class="segmenteditor-container-and-header" id="<%=xssAPI.encodeForHTMLAttr(id)%>"><%= i18n.get("AND", "Logical AND in ClientContext segment editor") %></div>
    <div class="segmenteditor-container-and">
        <cq:include path="andpar" resourceType="foundation/components/parsys"/>
    </div>
</div>
