...
<%  } else { %>
	        ...
	        // configure this from a setting somewhere.
	        //
		    CQ_Analytics.AAM.SegmentsManager = CQ_Analytics.AAM.SegmentsManager || new CQ_Analytics.AAM.SegmentsMgr(
		    	CQ_Analytics.AAM.AudienceManager,
		    	{
			        store_name : "aamsegments",
			        configPath : "<%= configPath %>",
			        partner : "<%= partner %>",
			        containerNSID : "<%= containerNSID %>"
		    });
	        // console.log("Done Creating CQ_Analytics.AAM.SegmentsManager  in aamsegments "+CQ_Analytics.AAM.SegmentsManager);
<%  } %>
    }
} catch(e) {
