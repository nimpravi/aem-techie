...
%><%@include file="/libs/foundation/global.jsp"%><%
    ...
    %>
<c:set var="url" value="<%= properties.get("./linkurl",String.class) %>"/>
<c:set var="text" value="<%= properties.get("./linktext",String.class) %>"/>

<a href= '${url}'>${text}</a><br/>
<div id="<%= xssAPI.encodeForHTMLAttr(divId) %>"><a href= '${url}'><% image.draw(out); %></a></div><%
