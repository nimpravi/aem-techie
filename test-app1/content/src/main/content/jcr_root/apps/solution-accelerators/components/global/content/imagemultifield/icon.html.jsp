...
if(children.hasNext()){
    ...
    Node node = null;
    %>
<section class="global-brands hidden-xs hidden-sm">
 <div class="container">
     <div class="row-fluid">
        <div class="col-md-12"> 
...
<section class="global-brands visible-xs visible-sm hidden-lg hidden-md">
     <div class="container-fluid">
        <div class="row">
            <div class="col-md-12"> 
                <h4 id="globalBrand"> 
                <img src='<%=currentNode.getProperty("iconReference").getString()%>' type="image/png" alt="'<%=currentNode.getProperty("alt").getString()%>'" >
                 <%=currentNode.getProperty("linktext").getString()%> 
                    <button type="button" class="btn btn-success " data-toggle="collapse" data-target="#demo" aria-expanded="true" aria-controls="demo">
