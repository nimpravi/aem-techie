 ...
 * 
 */
public class ContentCreationException extends AcceleratorException {
	 ...
	 * @param faultCode
	 */
	public ContentCreationException(AcceleratorFaultCode faultCode) {
		super(faultCode);
	}
	 ...
	 * @param msg
	 */
	public ContentCreationException(String msg) {
		super(msg);
	}
	 ...
	 * @param cause
	 */
	public ContentCreationException(String msg, Throwable cause) {
		super(msg, cause);
	}
	 ...
	 * @param cause
	 */
	public ContentCreationException(String message, String className,
