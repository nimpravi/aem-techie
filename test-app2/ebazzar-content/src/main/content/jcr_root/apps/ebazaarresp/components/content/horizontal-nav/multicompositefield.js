 ...
 */
CQ.form.MtMultiCompositeField = CQ.Ext.extend(CQ.form.CompositeField, {
...
[{
    ...
    constructor: function(config) {
        ...
        CQ.form.MtMultiCompositeField.superclass.constructor.call(this,config);
        ...
        //this.addEvents(
         ...
         //     * Fires when the value is changed.
          //   * @param {CQ.form.MtMultiCompositeField} this
    ...
    initComponent: function() {
        CQ.form.MtMultiCompositeField.superclass.initComponent.call(this);
            ...
            if (this.fieldWidth > 0) {
                for (var i = 0; i < this.items.length; i++) {
                    try {
                        ...
                        CQ.Log.debug("CQ.form.MtMultiCompositeField#initComponent: " + e.message);
                    }
                }
            }
        });*/
    ...
    addItem: function(name, o) {
        ...
        var item = this.insert(this.items.getCount() - 1, {
            xtype: "mtmulticompositefielditem",
            name: name,
...
/*
  ...
  setValue: function(value) {
        ...
        //console.log("MtMultiCompositeField.setValue was called");
...
CQ.Ext.reg("mtmulticompositefield", CQ.form.MtMultiCompositeField);
 ...
 * @param {Object} config The config object
 */
CQ.form.MtMultiCompositeField.Item = CQ.Ext.extend(CQ.Ext.Panel, {

    /**
     * @cfg {String} name
     * @member CQ.form.MtMultiCompositeField.Item
     * Name of this item.
     */
    /**
     * @cfg {String} prefix
...
//    initComponent: function() {
//        CQ.form.MtMultiCompositeField.Item.superclass.initComponent.call(this);
...
//    },
     ...
     * @param item {CQ.form.MtMultiCompositeField.Item} The item to reorder above
     * @member CQ.form.MtMultiCompositeField.Item
     */
...
CQ.Ext.reg("mtmulticompositefielditem", CQ.form.MtMultiCompositeField.Item);