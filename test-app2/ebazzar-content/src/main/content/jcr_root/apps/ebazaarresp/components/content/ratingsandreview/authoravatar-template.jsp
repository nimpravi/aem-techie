...
%><%@ page import="com.adobe.cq.social.commons.Comment,
                    com.adobe.cq.social.commons.CollabUser,
                    com.adobe.cq.social.commons.CollabUtil" %><%
%><%
String email = "";
UserProperties userProperties = (UserProperties)slingRequest.getAttribute("userProperties");
email = userProperties.getProperty("email", "", String.class);
resourceAuthorAvatar = CollabUtil.getAvatar(userProperties,email,absoluteDefaultAvatar);
Resource res = (Resource)slingRequest.getAttribute("res");
    final Comment post = res.adaptTo(Comment.class);
