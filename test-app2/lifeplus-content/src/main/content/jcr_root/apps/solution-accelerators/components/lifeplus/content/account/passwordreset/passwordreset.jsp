...
%><%
    ...
    final String action="/apps/solution-accelerators/components/lifeplus/content/account/actions/setpwd";
    ...
    if (key == null && uid == null) {
        ...
        try {
            ...
            if(null!=userProfileNode){
            	userProfileNode.setProperty("forgotPasswordVerificationUID",key);
...
<form id="<%= xssAPI.encodeForHTMLAttr(id) %>" name="<%= xssAPI.encodeForHTMLAttr(id) %>"
       								 method="POST" action="/bin/PasswordReset" enctype="multipart/form-data" class="design_form">
    ...
    <div class="form_rightcol">
    	<input type="submit" value="Reset Password" class="primary_button">
    </div>
