 ...
 */
CQ.form.Slideshow = CQ.Ext.extend(CQ.form.SmartImage, {
    ...
    constructor: function(config) {
        ...
        var defaults = {
            ...
            "footPanel": new CQ.form.Slideshow.TitlePanel({ }),
        ...
        CQ.form.Slideshow.superclass.constructor.call(this, config);
    ...
    initComponent: function() {
        CQ.form.Slideshow.superclass.initComponent.call(this);
    },
    ...
    afterRender: function() {
        CQ.form.Slideshow.superclass.afterRender.call(this);
    ...
    createSlide: function(data, slideIndex, basePath) {
        ...
        if (data && fileRef) {
            ...
            if (referencedFileInfo) {
                slide = new CQ.form.Slideshow.Slide({
...
// register xtype
CQ.Ext.reg('customslideshow', CQ.form.Slideshow);