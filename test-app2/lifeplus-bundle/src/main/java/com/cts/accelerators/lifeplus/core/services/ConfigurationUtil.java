package com.cts.accelerators.lifeplus.core.services;
...
public class ConfigurationUtil {
			...
			if (configAdmin != null) {
				...
				if (conf != null) {
					if (null != conf.getProperties()
						...
						LOGGER.info(" || " + methodName + " || value1 || "+conf.getProperties().get(key).toString());
	 ...
	 * @throws AcceleratorException
	 */
	public String[] getMultiFiledConfig(String pid, String key)
			throws AcceleratorException {
		String methodName = "getMultiFiledConfig";
		LOGGER.info(" || " + methodName + " || START");
